 ...
 */
public class DatasetTableIdResource extends PaginatedServerResource implements FilteredResource
{
	@Post("json")
	public PaginatedResult<List<Integer>> getJson(PaginatedRequest request)
	{
		...
		{
			SelectJoinStep<Record1<Integer>> from = context.selectDistinct(VIEW_TABLE_DATASETS.DATASET_ID)
