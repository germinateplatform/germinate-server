...
import static jhi.germinate.server.database.tables.ViewTableLocationsGroups.*;

/**
 * @author Sebastian Raubach
 */
public class LocationGroupTableResource extends PaginatedServerResource implements FilteredResource
{
	...
	@Post("json")
	public PaginatedResult<List<ViewTableLocationsGroups>> getJson(PaginatedRequest request)
	{
			 ...
			 DSLContext context = Database.getContext(conn))
		{
			...
			List<ViewTableLocationsGroups> result = setPaginationAndOrderBy(from)
				.fetch()
				.into(ViewTableLocationsGroups.class);
