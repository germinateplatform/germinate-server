...
public class Phenotypedata extends TableImpl<PhenotypedataRecord> {
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.phenotype_id</code>. Foreign key phenotypes (phenotype.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.germinatebase_id</code>. Foreign key germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.phenotype_value</code>. The phenotype value for this phenotype_id and germinatebase_id combination.
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.dataset_id</code>. Foreign key datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.recording_date</code>. Date when the phenotypic result was recorded. Should be formatted 'YYYY-MM-DD HH:MM:SS' or just 'YYYY-MM-DD' where a timestamp is not available.
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.treatment_id</code>. Foreign key to treatments (treatments.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_7_0.phenotypedata.trialseries_id</code>. Foreign key to trialseries (trialseries.id).
     */
    ...
    /**
     * Create a <code>germinate_template_3_7_0.phenotypedata</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_3_7_0.phenotypedata</code> table reference
     */
