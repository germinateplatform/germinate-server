...
public class Comments extends TableImpl<CommentsRecord> {
    ...
    private static final long serialVersionUID = -1841822107;

    /**
     * The reference instance of <code>germinate_template_3_6_0.comments</code>
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.commenttype_id</code>. Foreign key to commentypes (commenttypes.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.visibility</code>. Defines if the comment is available or masked (hidden) from the interface.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.description</code>. The comment content.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.reference_id</code>. Relates to the UID of the table to which the comment relates
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.comments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_3_6_0.comments</code> table reference
     */
    public Comments() {
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.comments</code> table reference
     */
