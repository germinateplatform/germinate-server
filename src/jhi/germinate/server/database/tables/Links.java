...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The reference instance of <code>germinate_template_3_6_0.links</code>
     */
    public static final Links LINKS = new Links();
    private static final long serialVersionUID = -1405185318;
    /**
     * The column <code>germinate_template_3_6_0.links.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.linktype_id</code>. Foreign key to linktypes (linktypes.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.foreign_id</code>.
     */
    public final TableField<LinksRecord, Integer> FOREIGN_ID = createField("foreign_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
    /**
     * The column <code>germinate_template_3_6_0.links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.description</code>. A description of the link.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    public final TableField<LinksRecord, Timestamp> UPDATED_ON = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    /**
     * Create a <code>germinate_template_3_6_0.links</code> table reference
     */
    public Links() {
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.links</code> table reference
     */
