...
public class Datasetpermissions extends TableImpl<DatasetpermissionsRecord> {
    ...
    /**
     * The reference instance of <code>germinate_template_3_6_0.datasetpermissions</code>
     */
    public static final Datasetpermissions DATASETPERMISSIONS = new Datasetpermissions();
    private static final long serialVersionUID = -502357683;
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.dataset_id</code>. Foreign key to datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper usersid).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.group_id</code>. Foreign key to usergroups table.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasetpermissions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_3_6_0.datasetpermissions</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.datasetpermissions</code> table reference
     */
