...
public class Usergroups extends TableImpl<UsergroupsRecord> {
    ...
    /**
     * Create a <code>germinate_template_3_6_0.usergroups</code> table reference
     */
    public Usergroups() {
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.usergroups</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USERGROUPS_PRIMARY);
    }
    ...
    public Identity<UsergroupsRecord, Integer> getIdentity() {
        return Keys.IDENTITY_USERGROUPS;
    }
    ...
    public UniqueKey<UsergroupsRecord> getPrimaryKey() {
        return Keys.KEY_USERGROUPS_PRIMARY;
    }
    ...
    public List<UniqueKey<UsergroupsRecord>> getKeys() {
        return Arrays.<UniqueKey<UsergroupsRecord>>asList(Keys.KEY_USERGROUPS_PRIMARY);
    }
