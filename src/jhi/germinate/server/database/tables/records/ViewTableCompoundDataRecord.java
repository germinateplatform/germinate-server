...
public class ViewTableCompoundDataRecord extends TableRecordImpl<ViewTableCompoundDataRecord> implements Record12<Integer, String, String, String, Integer, String, String, Integer, String, String, Timestamp, BigDecimal> {
    ...
    private static final long serialVersionUID = -151221110;
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.entity_type</code>. The name of the entity type.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.compound_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_template_3_7_0.view_table_compound_data.compound_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.compound_name</code>. Compound full name.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.recording_date</code>. Date when the phenotypic result was recorded. Should be formatted 'YYYY-MM-DD HH:MM:SS' or just 'YYYY-MM-DD' where a timestamp is not available.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_7_0.view_table_compound_data.compound_value</code>. The compound value for this compound_id and germinatebase_id combination.
     */
