...
public class NewsRecord extends UpdatableRecordImpl<NewsRecord> implements Record9<Integer, Integer, String, String, String, String, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -796485460;
    ...
    /**
     * Setter for <code>germinate_template_3_6_0.news.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_6_0.news.content</code>. The textual content of this news item.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_6_0.news.image</code>. Image to use with this news item.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_6_0.news.hyperlink</code>. HTML hyperlink to use for this news item. This can be a link to another source which contains more information or a link to the original source.
     */
    ...
    /**
     * Setter for <code>germinate_template_3_6_0.news.user_id</code>. Foreign key users (users.id).
     */
