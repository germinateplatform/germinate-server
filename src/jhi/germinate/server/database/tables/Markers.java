...
public class Markers extends TableImpl<MarkersRecord> {
    ...
    /**
     * The reference instance of <code>germinate_template_3_6_0.markers</code>
     */
    public static final Markers MARKERS = new Markers();
    private static final long serialVersionUID = -44044474;
    /**
     * The column <code>germinate_template_3_6_0.markers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.markers.markertype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.markers.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.markers.created_on</code>. When the record was created.
    ...
    /**
     * The column <code>germinate_template_3_6_0.markers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_3_6_0.markers</code> table reference
     */
    public Markers() {
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.markers</code> table reference
     */
