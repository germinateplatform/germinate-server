...
public class Mapdefinitions extends TableImpl<MapdefinitionsRecord> {
    ...
    private static final long serialVersionUID = 1443952880;

    /**
     * The reference instance of <code>germinate_template_3_6_0.mapdefinitions</code>
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.mapfeaturetype_id</code>. Foreign key to mapfeaturetypes (mapfeaturetypes.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.marker_id</code>. Foreign key to markers (markers.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.map_id</code>. Foreign key to maps (maps.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.definition_start</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker start location.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.definition_end</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker end location.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.chromosome</code>. The chromosome/linkage group that this marker is found on.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.arm_impute</code>. If a chromosome arm is available then this can be entered here.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.mapdefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_3_6_0.mapdefinitions</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.mapdefinitions</code> table reference
     */
