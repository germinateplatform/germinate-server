...
public class Datasets extends TableImpl<DatasetsRecord> {
    ...
    private static final long serialVersionUID = -1191397328;

    /**
     * The reference instance of <code>germinate_template_3_6_0.datasets</code>
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.experiment_id</code>. Foreign key to experiments (experiments.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.name</code>. Describes the dataset.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.description</code>. The name of this dataset.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.date_start</code>. Date that the dataset was generated.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.date_end</code>. Date at which the dataset recording ended.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.source_file</code>.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.datatype</code>. A description of the data type of the contained data. Examples might be: "raw data", "BLUPs", etc.
     */
    ...
    public final TableField<DatasetsRecord, Object> DUBLIN_CORE = createField("dublin_core", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_3_6_0\".\"datasets_dublin_core\""), this, "");

    /**
     * The column <code>germinate_template_3_6_0.datasets.version</code>. Dataset version if this exists.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.created_by</code>. Defines who created the dataset. This is a FK in Gatekeeper users table. Foreign key to Gatekeeper users (users.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.dataset_state_id</code>. Foreign key to datasetstates (datasetstates.id).
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.license_id</code>.
     */
    public final TableField<DatasetsRecord, Integer> LICENSE_ID = createField("license_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>germinate_template_3_6_0.datasets.is_external</code>. Defines if the dataset is contained within Germinate or from an external source and not stored in the database.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.hyperlink</code>. Link to access the external dasets.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.created_on</code>. When the record was created.
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * The column <code>germinate_template_3_6_0.datasets.contact</code>. The contact to get more information about this dataset.
     */
    ...
    /**
     * Create a <code>germinate_template_3_6_0.datasets</code> table reference
     */
    public Datasets() {
    ...
    /**
     * Create an aliased <code>germinate_template_3_6_0.datasets</code> table reference
     */
