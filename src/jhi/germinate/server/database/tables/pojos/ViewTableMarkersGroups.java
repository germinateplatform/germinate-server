...
public class ViewTableMarkersGroups implements Serializable {

    private static final long serialVersionUID = 1391762970;
    ...
    public ViewTableMarkersGroups(ViewTableMarkersGroups value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ViewTableMarkersGroups (");
