...
public class ViewTableGermplasmGroups implements Serializable {

    private static final long serialVersionUID = 1923524889;
    ...
    public ViewTableGermplasmGroups(ViewTableGermplasmGroups value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ViewTableGermplasmGroups (");
