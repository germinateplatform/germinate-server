...
public class ViewTableGroupLocations implements Serializable {

    private static final long serialVersionUID = 63719020;
    ...
    public ViewTableGroupLocations(ViewTableGroupLocations value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ViewTableGroupLocations (");
