...
public class Taxonomies extends TableImpl<TaxonomiesRecord> {
    ...
    private static final long serialVersionUID = 1053764991;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.taxonomies</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.genus</code>. Genus name for the species.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.species</code>. Species name in lowercase.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.subtaxa</code>. Subtaxa name.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.species_author</code>. also known as spauthor in the Multi Crop Passport Descriptors (MCPD V2 2012). Describes the authority for the species name.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.subtaxa_author</code>. also known as subtauthor in the Multi Crop Passport Descriptors (MCPD V2 2012).
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.cropname</code>. The name of the crop. This should be the common name. Examples would include barley, maize, wheat, rice and so on.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.ploidy</code>. Defines the ploidy level for the species. Use numbers to reference ploidy for example diploid = 2, tetraploid = 4.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.taxonomies.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_20_06_15.taxonomies</code> table reference
     */
    public Taxonomies() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.taxonomies</code> table reference
     */
