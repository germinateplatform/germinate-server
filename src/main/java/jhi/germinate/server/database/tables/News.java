...
public class News extends TableImpl<NewsRecord> {
    ...
    private static final long serialVersionUID = -2129193279;

    /**
     * The reference instance of <code>germinate_template_4_0_0.news</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.newstype_id</code>. Foreign key newstypes (newstypes.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.title</code>. A title which is used to name this news item. This appears in the Germinate user interface if used.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.content</code>. The textual content of this news item.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.image</code>. Image to use with this news item.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.hyperlink</code>. HTML hyperlink to use for this news item. This can be a link to another source which contains more information or a link to the original source.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.user_id</code>. Foreign key users (users.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.news.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    public final TableField<NewsRecord, Timestamp> UPDATED_ON = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    /**
     * Create a <code>germinate_template_4_0_0.news</code> table reference
     */
    public News() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.news</code> table reference
     */
