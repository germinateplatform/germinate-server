...
public class ViewMcpd extends TableImpl<ViewMcpdRecord> {
    ...
    private static final long serialVersionUID = -555122933;

    /**
     * The reference instance of <code>germinate_template_4_0_0.view_mcpd</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ID</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.PUID</code>. Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.INSTCODE</code>. If there is a defined ISO code for the institute this should be used here.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ACCENUMB</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLNUMB</code>. Original identifier assigned by the collector(s) of the sample, normally composed of the name or
...
identifying duplicates held in different collections.
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLCODE</code>. FAO WIEWS code of the institute collecting the sample. If the holding institute has collected the
...
without space.
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLNAME</code>. Name of the institute collecting the sample. This descriptor should be used only if COLLCODE cannot be filled because the FAO WIEWS code for this institute is not available. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLINSTADDRESS</code>. The postal address of the institute.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLMISSID</code>. Identifier of the collecting mission used by the Collecting Institute (4 or 4.1) (e.g. 'CIATFOR-052', 'CN426').
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.GENUS</code>. Genus name for the species.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.SPECIES</code>. Species name in lowercase.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.SPAUTHOR</code>. also known as spauthor in the Multi Crop Passport Descriptors (MCPD V2 2012). Describes the authority for the species name.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.SUBTAXA</code>. Subtaxa name.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.SUBTAUTHOR</code>. also known as subtauthor in the Multi Crop Passport Descriptors (MCPD V2 2012).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.CROPNAME</code>. The name of the crop. This should be the common name. Examples would include barley, maize, wheat, rice and so on.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ACCENAME</code>. This is the unique identifier for accessions within a genebank, and is assigned when a sample is
entered into the genebank collection (e.g. ‘PI 113869’).
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ACQDATE</code>.
     */
    public final TableField<ViewMcpdRecord, String> ACQDATE = createField("ACQDATE", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ORIGCTY</code>. ISO 3 Code for country.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLSITE</code>. The site name where the location is.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DECLATITUDE</code>. Latitude of the location.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.LATITUDE</code>.
     */
    public final TableField<ViewMcpdRecord, byte[]> LATITUDE = createField("LATITUDE", org.jooq.impl.SQLDataType.BINARY, this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DECLONGITUDE</code>. Longitude of the location.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.LONGITUDE</code>.
     */
    public final TableField<ViewMcpdRecord, byte[]> LONGITUDE = createField("LONGITUDE", org.jooq.impl.SQLDataType.BINARY, this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COORDUNCERT</code>. Uncertainty associated with the coordinates in metres. Leave the value empty if the uncertainty is unknown. 
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COORDDATUM</code>. The geodetic datum or spatial reference system upon which the coordinates given in decimal latitude and decimal longitude are based (e.g. WGS84, ETRS89, NAD83). The GPS uses the WGS84 datum.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.GEOREFMETH</code>. The georeferencing method used (GPS, determined from map, gazetteer, or estimated using software). Leave the value empty if georeferencing method is not known.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ELEVATION</code>. The elevation of the site in metres.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLDATE</code>.
     */
    public final TableField<ViewMcpdRecord, String> COLLDATE = createField("COLLDATE", org.jooq.impl.SQLDataType.VARCHAR(10), this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.BREDCODE</code>. FAO WIEWS code of the institute that has bred the material. If the holding institute has bred the material, the breeding institute code (BREDCODE) should be the same as the holding institute code (INSTCODE). Follows INSTCODE standard. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.BREDNAME</code>. Name of the institute (or person) that bred the material. This descriptor should be used only if BREDCODE cannot be filled because the FAO WIEWS code for this institute is not available. Multiple names are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.SAMPSTAT</code>. Foreign key to biologicalstatus (biologicalstaus.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ANCEST</code>. The pedigree string which is used to represent the germinatebase entry.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.COLLSRC</code>. Foreign key to collectionsources (collectionsources.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DONORCODE</code>. FAO WIEWS code of the donor institute. Follows INSTCODE standard.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DONORNAME</code>. Name of the donor institute (or person). This descriptor should be used only if DONORCODE cannot be filled because the FAO WIEWS code for this institute is not available.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DONORNUMB</code>. Identifier assigned to an accession by the donor. Follows ACCENUMB standard.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.OTHERNUMB</code>. Any other identifiers known to exist in other collections for this accession. Use the following format: INSTCODE:ACCENUMB;INSTCODE:identifier;… INSTCODE and identifier are separated by a colon without space. Pairs of INSTCODE and identifier are separated by a semicolon without space. When the institute is not known, the identifier should be preceded by a colon.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DUPLSITE</code>. FAO WIEWS code of the institute(s) where a safety duplicate of the accession is maintained.
Multiple values are separated by a semicolon without space. Follows INSTCODE standard.
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.DUPLINSTNAME</code>. Name of the institute where a safety duplicate of the accession is maintained. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.STORAGE</code>.
     */
    public final TableField<ViewMcpdRecord, String> STORAGE = createField("STORAGE", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.MLSSTAT</code>. Foreign key to mlsstatus (mlsstatus.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.REMARKS</code>.
     */
    public final TableField<ViewMcpdRecord, String> REMARKS = createField("REMARKS", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ENTITYTYPE</code>. The name of the entity type.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ENTITYPARENTID</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_mcpd.ENTITYPARENTACCENUMB</code>.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.view_mcpd</code> table reference
     */
    public ViewMcpd() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.view_mcpd</code> table reference
     */
