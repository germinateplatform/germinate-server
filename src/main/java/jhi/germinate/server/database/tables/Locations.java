...
public class Locations extends TableImpl<LocationsRecord> {
    ...
    private static final long serialVersionUID = -1188538618;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.locations</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.locationtype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.country_id</code>. Foreign key to countries (countries.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.state</code>. The state where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.region</code>. The region where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.site_name</code>. The site name where the location is.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.site_name_short</code>. Shortened site name which can be used in tables within Germinate.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.elevation</code>. The elevation of the site in metres.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.latitude</code>. Latitude of the location.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.longitude</code>. Longitude of the location.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.coordinate_uncertainty</code>. Uncertainty associated with the coordinates in metres. Leave the value empty if the uncertainty is unknown. 
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.coordinate_datum</code>. The geodetic datum or spatial reference system upon which the coordinates given in decimal latitude and decimal longitude are based (e.g. WGS84, ETRS89, NAD83). The GPS uses the WGS84 datum.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.georeferencing_method</code>. The georeferencing method used (GPS, determined from map, gazetteer, or estimated using software). Leave the value empty if georeferencing method is not known.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.locations.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    public final TableField<LocationsRecord, Timestamp> UPDATED_ON = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    /**
     * Create a <code>germinate_template_4_20_06_15.locations</code> table reference
     */
    public Locations() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.locations</code> table reference
     */
