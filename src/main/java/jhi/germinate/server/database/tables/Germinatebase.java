...
public class Germinatebase extends TableImpl<GerminatebaseRecord> {
    ...
    private static final long serialVersionUID = -1965714990;

    /**
     * The reference instance of <code>germinate_template_4_0_0.germinatebase</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.general_identifier</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.number</code>. This is the unique identifier for accessions within a genebank, and is assigned when a sample is
entered into the genebank collection (e.g. ‘PI 113869’).
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.bank_number</code>. Alternative genebank number.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.breeders_code</code>. FAO WIEWS code of the institute that has bred the material. If the holding institute has bred the material, the breeding institute code (BREDCODE) should be the same as the holding institute code (INSTCODE). Follows INSTCODE standard. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.taxonomy_id</code>. Foreign key to taxonomies (taxonomies.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.institution_id</code>. Foreign key to institutions (institutions.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.plant_passport</code>. Record if the entry has a plant passport.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.donor_code</code>. FAO WIEWS code of the donor institute. Follows INSTCODE standard.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.donor_name</code>. Name of the donor institute (or person). This descriptor should be used only if DONORCODE cannot be filled because the FAO WIEWS code for this institute is not available.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.donor_number</code>. Identifier assigned to an accession by the donor. Follows ACCENUMB standard.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.acqdate</code>. Date on which the accession entered the collection where YYYY is the year, MM is the month and
DD is the day. Missing data (MM or DD) should be indicated with hyphens or ‘00’ [double zero].
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.collnumb</code>. Original identifier assigned by the collector(s) of the sample, normally composed of the name or
...
identifying duplicates held in different collections.
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.colldate</code>. Collecting date of the sample, where YYYY is the year, MM is the month and DD is the day.
Missing data (MM or DD) should be indicated with hyphens or ‘00’ [double zero]. 
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.collcode</code>. FAO WIEWS code of the institute collecting the sample. If the holding institute has collected the
...
without space.
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.collname</code>. Name of the institute collecting the sample. This descriptor should be used only if COLLCODE cannot be filled because the FAO WIEWS code for this institute is not available. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.collmissid</code>. Identifier of the collecting mission used by the Collecting Institute (4 or 4.1) (e.g. 'CIATFOR-052', 'CN426').
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.othernumb</code>. Any other identifiers known to exist in other collections for this accession. Use the following format: INSTCODE:ACCENUMB;INSTCODE:identifier;… INSTCODE and identifier are separated by a colon without space. Pairs of INSTCODE and identifier are separated by a semicolon without space. When the institute is not known, the identifier should be preceded by a colon.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.duplsite</code>. FAO WIEWS code of the institute(s) where a safety duplicate of the accession is maintained.
Multiple values are separated by a semicolon without space. Follows INSTCODE standard.
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.duplinstname</code>. Name of the institute where a safety duplicate of the accession is maintained. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.mlsstatus_id</code>. Foreign key to mlsstatus (mlsstatus.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.puid</code>. Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.biologicalstatus_id</code>. Foreign key to biologicalstatus (biologicalstaus.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.collsrc_id</code>. Foreign key to collectionsources (collectionsources.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.entitytype_id</code>. Foreign key to entitytypes (entitytypes.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.entityparent_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.pdci</code>. Passport Data Completeness Index. This is calculated by Germinate. Manual editing of this field will be overwritten.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.germinatebase.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.germinatebase</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.germinatebase</code> table reference
     */
