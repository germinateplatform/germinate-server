...
public class Groupmembers extends TableImpl<GroupmembersRecord> {
    ...
    private static final long serialVersionUID = 2049741247;

    /**
     * The reference instance of <code>germinate_template_4_0_0.groupmembers</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.groupmembers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.groupmembers.foreign_id</code>. Foreign key to [table] ([table].id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.groupmembers.group_id</code>. Foreign key to groups (groups.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.groupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.groupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.groupmembers</code> table reference
     */
    public Groupmembers() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.groupmembers</code> table reference
     */
