...
public class ViewTableGroups extends TableImpl<ViewTableGroupsRecord> {
    ...
    private static final long serialVersionUID = 359407105;

    /**
     * The reference instance of <code>germinate_template_4_0_0.view_table_groups</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_name</code>. The name of the group which can be used to identify it.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_description</code>. A free text description of the group. This has no length limitations.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_type_id</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_type</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.user_name</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.user_id</code>. Defines who created the group. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.group_visibility</code>. Defines if the group is visuble or hidden from the Germinate user interface.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.created_on</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_groups.count</code>.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.view_table_groups</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.view_table_groups</code> table reference
     */
