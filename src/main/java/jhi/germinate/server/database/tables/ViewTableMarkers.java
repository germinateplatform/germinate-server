...
public class ViewTableMarkers extends TableImpl<ViewTableMarkersRecord> {
    ...
    private static final long serialVersionUID = 1108197329;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.view_table_markers</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.marker_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.marker_type</code>. Describes the marker type. Markers (markers) have a defined type. This could be AFLP, MicroSat, SNP and so on.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.marker_synonyms</code>. The synonyms as a json array.
     */
    public final TableField<ViewTableMarkersRecord, JsonArray> MARKER_SYNONYMS = createField("marker_synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_20_06_15\".\"view_table_markers_marker_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.created_on</code>. When the record was created.
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_markers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_20_06_15.view_table_markers</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.view_table_markers</code> table reference
     */
