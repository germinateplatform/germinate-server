...
public class PedigreedefinitionsRecord extends UpdatableRecordImpl<PedigreedefinitionsRecord> implements Record7<Integer, Integer, Integer, Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 2124375310;

    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.germinatebase_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.germinatebase_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.pedigreenotation_id</code>. Foreign key to pedigreenotations (pedigreenotations.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.pedigreenotation_id</code>. Foreign key to pedigreenotations (pedigreenotations.id).
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.pedigreedescription_id</code>.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.pedigreedescription_id</code>.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.definition</code>. The pedigree string which is used to represent the germinatebase entry.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.definition</code>. The pedigree string which is used to represent the germinatebase entry.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigreedefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigreedefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
