...
public class ViewStatsOverviewRecord extends TableRecordImpl<ViewStatsOverviewRecord> implements Record7<Long, Long, Long, Long, Long, Long, Long> {

    private static final long serialVersionUID = 1586946978;
     ...
     */
    @Override
    public ViewStatsOverviewRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewStatsOverviewRecord(Long germplasm, Long markers, Long traits, Long compounds, Long locations, Long groups, Long images) {
        super(ViewStatsOverview.VIEW_STATS_OVERVIEW);
