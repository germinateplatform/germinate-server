...
public class Units extends TableImpl<UnitsRecord> {
    ...
    private static final long serialVersionUID = 412850018;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.units</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.units.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_20_06_15.units</code> table reference
     */
    public Units() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.units</code> table reference
     */
