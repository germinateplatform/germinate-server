...
public class ViewTableCollaborators extends TableImpl<ViewTableCollaboratorsRecord> {
    ...
    private static final long serialVersionUID = 102928570;

    /**
     * The reference instance of <code>germinate_template_4_0_0.view_table_collaborators</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.collaborator_id</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.collaborator_first_name</code>. Last name (surname) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.collaborator_last_name</code>. First name (and middle name if available) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.collaborator_email</code>. E-mail address of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.collaborator_phone</code>. Phone number of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.institution_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.institution_name</code>. The institute name.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.institution_address</code>. The postal address of the institute.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.country_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.country_name</code>. Country name.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.country_code2</code>. ISO 2 Code for country.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_collaborators.country_code3</code>. ISO 3 Code for country.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.view_table_collaborators</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.view_table_collaborators</code> table reference
     */
