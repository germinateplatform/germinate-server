...
public class Climateoverlays extends TableImpl<ClimateoverlaysRecord> {
    ...
    private static final long serialVersionUID = -911116946;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.climateoverlays</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.climate_id</code>. Foreign key to climates (climates.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.path</code>. This is the path for holding images which can be used as overlays for the Google Maps representation in Germinate. The path is relative.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.bottom_left_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.bottom_left_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.top_right_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.top_right_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.is_legend</code>. The legend for the image. What colours represent in the overlays. This is not required but used if present. 
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.description</code>. Describes the climate overlay if additional explanation of  the overlay image is required.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.climateoverlays.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    public final TableField<ClimateoverlaysRecord, Timestamp> UPDATED_ON = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    /**
     * Create a <code>germinate_template_4_20_06_15.climateoverlays</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.climateoverlays</code> table reference
     */
