...
public class Collaborators extends TableImpl<CollaboratorsRecord> {
    ...
    private static final long serialVersionUID = -878969902;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.collaborators</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.id</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.first_name</code>. Last name (surname) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.last_name</code>. First name (and middle name if available) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.email</code>. E-mail address of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.phone</code>. Phone number of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.institution_id</code>. Author's affiliation when the resource was created. Foreign key to 'institutions'
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.collaborators.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_20_06_15.collaborators</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.collaborators</code> table reference
     */
