...
public class Attributes extends TableImpl<AttributesRecord> {
    ...
    private static final long serialVersionUID = -617114993;

    /**
     * The reference instance of <code>germinate_template_4_0_0.attributes</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.datatype</code>. Describes the data type of the attribute. This can be INT, FLOAT or CHAR type.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.target_table</code>.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.attributes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.attributes</code> table reference
     */
    public Attributes() {
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.attributes</code> table reference
     */
