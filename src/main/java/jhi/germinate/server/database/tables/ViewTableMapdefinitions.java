...
public class ViewTableMapdefinitions extends TableImpl<ViewTableMapdefinitionsRecord> {
    ...
    private static final long serialVersionUID = 2112859632;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.view_table_mapdefinitions</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.marker_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.synonyms</code>. The synonyms as a json array.
     */
    public final TableField<ViewTableMapdefinitionsRecord, JsonArray> SYNONYMS = createField("synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_20_06_15\".\"view_table_mapdefinitions_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.map_feature_type</code>. Description of the feature type. This could include a definition of the marker type such as 'SNP', 'KASP' or 'AFLP'.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.map_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.visibility</code>. Determines if the map is visible to the Germinate interface or hidden.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.map_name</code>. Describes the map.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.chromosome</code>. The chromosome/linkage group that this marker is found on.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_mapdefinitions.position</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker start location.
     */
    ...
    /**
     * Create a <code>germinate_template_4_20_06_15.view_table_mapdefinitions</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.view_table_mapdefinitions</code> table reference
     */
