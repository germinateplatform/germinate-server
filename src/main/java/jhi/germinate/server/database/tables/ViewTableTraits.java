...
public class ViewTableTraits extends TableImpl<ViewTableTraitsRecord> {
    ...
    private static final long serialVersionUID = -810305390;

    /**
     * The reference instance of <code>germinate_template_4_0_0.view_table_traits</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.trait_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.trait_name</code>. Phenotype full name.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.trait_name_short</code>. Shortened name for the phenotype. This is used in table columns where space is an issue.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.trait_description</code>. Full description of the phenotype. This should contain enough infomation to accurately identify the phenoytpe and how it was recorded.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.data_type</code>. Defines the data type of the phenotype. This can be of float, int or char types.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.unit_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.synonyms</code>. The synonyms as a json array.
     */
    public final TableField<ViewTableTraitsRecord, JsonArray> SYNONYMS = createField("synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_0_0\".\"view_table_traits_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_template_4_0_0.view_table_traits.count</code>.
     */
    public final TableField<ViewTableTraitsRecord, Long> COUNT = createField("count", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * Create a <code>germinate_template_4_0_0.view_table_traits</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.view_table_traits</code> table reference
     */
