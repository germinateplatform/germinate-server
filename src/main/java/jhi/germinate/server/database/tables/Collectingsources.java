...
public class Collectingsources extends TableImpl<CollectingsourcesRecord> {
    ...
    private static final long serialVersionUID = -157250977;

    /**
     * The reference instance of <code>germinate_template_4_0_0.collectingsources</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.collectingsources.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.collectingsources.collsrc</code>. collsrc in the Multi Crop Passport Descriptors (MCPD V2 2012)
    ...
    /**
     * The column <code>germinate_template_4_0_0.collectingsources.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_template_4_0_0.collectingsources.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create a <code>germinate_template_4_0_0.collectingsources</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_0_0.collectingsources</code> table reference
     */
