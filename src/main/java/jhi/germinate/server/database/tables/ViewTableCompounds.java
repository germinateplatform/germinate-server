...
public class ViewTableCompounds extends TableImpl<ViewTableCompoundsRecord> {
    ...
    private static final long serialVersionUID = 52977671;

    /**
     * The reference instance of <code>germinate_template_4_20_06_15.view_table_compounds</code>
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.compound_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.compound_name</code>. Compound full name.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.compound_description</code>. Full description of the compound. This should contain enough infomation to accurately identify the compound and how it was recorded.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.unit_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.synonyms</code>. The synonyms as a json array.
     */
    public final TableField<ViewTableCompoundsRecord, JsonArray> SYNONYMS = createField("synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_20_06_15\".\"view_table_compounds_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_template_4_20_06_15.view_table_compounds.count</code>.
     */
    public final TableField<ViewTableCompoundsRecord, Long> COUNT = createField("count", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * Create a <code>germinate_template_4_20_06_15.view_table_compounds</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_template_4_20_06_15.view_table_compounds</code> table reference
     */
