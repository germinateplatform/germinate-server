...
public class PedigreesRecord extends UpdatableRecordImpl<PedigreesRecord> implements Record8<Integer, Integer, Integer, PedigreesRelationshipType, Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1662447153;

    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.germinatebase_id</code>. Foreign key germinatebase (germinatebase.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.germinatebase_id</code>. Foreign key germinatebase (germinatebase.id).
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.parent_id</code>. Foreign key germinatebase (germinatebase.id). This is the parrent of the individual identified in the germinatebase_id column.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.parent_id</code>. Foreign key germinatebase (germinatebase.id). This is the parrent of the individual identified in the germinatebase_id column.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.relationship_type</code>. Male or Female parent. Should be recorded as 'M' (male) or 'F' (female).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.relationship_type</code>. Male or Female parent. Should be recorded as 'M' (male) or 'F' (female).
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.pedigreedescription_id</code>. Foreign key pedigreedescriptions (pedigreedescriptions.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.pedigreedescription_id</code>. Foreign key pedigreedescriptions (pedigreedescriptions.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.relationship_description</code>. Can be used as a meta-data field to describe the relationships if a complex rellationship is required. Examples may include, 'is a complex cross containing', 'F4 generation' and so on. This is used by the Helium pedigree visualiztion tool.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.pedigrees.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.pedigrees.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
