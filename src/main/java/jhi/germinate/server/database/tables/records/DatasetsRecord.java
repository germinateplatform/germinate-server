...
public class DatasetsRecord extends UpdatableRecordImpl<DatasetsRecord> implements Record19<Integer, Integer, Integer, String, String, Date, Date, String, String, DublinCore, String, Integer, Integer, Integer, Boolean, String, Timestamp, Timestamp, String> {
    ...
    private static final long serialVersionUID = 665736469;
    ...
    /**
     * Setter for <code>germinate_template_4_0_0.datasets.datasettype_id</code>. Foreign key to datasettypes (datasettypes.id).
     */
    ...
    /**
     * Getter for <code>germinate_template_4_0_0.datasets.datasettype_id</code>. Foreign key to datasettypes (datasettypes.id).
     */
