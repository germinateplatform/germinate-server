...
public class Germinate extends Application
{
	...
	public Restlet createInboundRoot()
	{
		...
		attachToRouter(routerAuth, "/dataset/attribute/table", DatasetAttributeTableResource.class);
		attachToRouter(routerAuth, "/dataset/attribute/table/export", DatasetAttributeTableExportResource.class);
		...
		attachToRouter(routerAuth, "/dataset/categorical/trial", TraitCategoricalResource.class);
		...
		attachToRouter(routerAuth, "/germplasm/{germplasmId}/stats/trait", GermplasmTraitStatsResource.class);
		...
		attachToRouter(routerAuth, "/germplasm/biologicalstatus", GermplasmBiologicalStatusResource.class);
		...
		attachToRouter(routerAuth, "/imagetag/{referenceTable}", ImageTagResource.class);
		attachToRouter(routerAuth, "/imagetag/{referenceTable}/{foreignId}", ImageTagResource.class);
		...
		if (PropertyWatcher.getBoolean(ServerProperty.BRAPI_ENABLED))
			new Brapi(PropertyWatcher.get(ServerProperty.GERMINATE_CLIENT_URL), "/brapi/v2", routerAuth, routerUnauth, verifier, PropertyWatcher.get(ServerProperty.DATA_DIRECTORY_EXTERNAL) + "/data/genotypes/");
