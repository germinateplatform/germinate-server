...
import static jhi.germinate.server.database.codegen.tables.ViewTableInstitutions.VIEW_TABLE_INSTITUTIONS;

@Path("institution/table")
@Secured
@PermitAll
public class InstitutionTableResource extends BaseResource
{
	@POST
